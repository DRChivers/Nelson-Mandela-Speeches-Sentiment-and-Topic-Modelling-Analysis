...
Of the 1,577 XML files available in the archive, after data cleaning only 1,400 are usable after removing files which had no date, files which contain no speeches, files which had non-English language speeches and no official translation, and so on. 
...
- mandela_sentiment_analysis.ipynb
- mandela_topic_model.ipynb
- mandela_topic_model_unique_high_low_sentiment.ipynb
# Libraries 
